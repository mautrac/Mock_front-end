...
export const UserHome = [ticketViewRoutes, ticketPriceView, viewFilmHomeRoutes, viewFilmRoutes, filmScheduleViewRoutes,  filmInforViewRoutes, cartRouts];
